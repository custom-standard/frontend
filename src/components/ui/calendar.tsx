  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-amber-200 text-primary-foreground hover:bg-amber-200 hover:text-primary-foreground focus:bg-amber-200 focus:text-primary-foreground",
        day_today: "bg-accent text-accent-foreground",
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-amber-200 aria-selected:text-muted-foreground aria-selected:opacity-30",
